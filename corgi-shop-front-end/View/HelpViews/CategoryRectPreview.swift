...
#Preview("Item") {
  let item = Item(uuid: UUID.init(), id: 1, name: "Item 1", price: 10, isFavorite: true, description: "This is item 1.", imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQacf4n1UIVbzFSiIDYZHnTSqHBxuT0BZuL3zgOJ5sgwVFGjADsd49Eqe0WYUkDCQ04MA&usqp=CAU")
